...
\begin{center}
  ...
  \begin{tikzpicture}
    \begin{axis}[xlabel=$x$,ylabel=$y$,domain=-0.5:0.5, y domain=-0.5:0.5,view/h=60,view/v=45,]
  ...
  \begin{tikzpicture}
    \begin{axis}[xlabel=$x$,ylabel=$y$,domain=-2:2, y domain=-2:2,view/h=60,view/v=45,]
  ...
  \begin{tikzpicture}
    \begin{axis}[xlabel=$x$,ylabel=$y$,domain=-4:4, y domain=-4:4,view/h=60,view/v=45,]
  ...
  \begin{tikzpicture}
    \begin{axis}[xlabel=$x$,ylabel=$y$,domain=-10:10, y domain=-10:10,view/h=65,view/v=40,]
